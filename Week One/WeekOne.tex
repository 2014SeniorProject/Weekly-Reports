...
\section{Individual Activity Synopsis}
	...
	\IEEEPARstart{T}{his} week I researched a new societal problem as we have scrapped the project we had chosen this summer. 
	...
	\renewcommand{\arraystretch}{1.3}
		...
		\hline\hline	
					...
					Societal Problem Research				& 6.0						& 100\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
	...
	\renewcommand{\arraystretch}{1.3}
		...
		\bfseries 	Task		 							& \bfseries Hours Worked	& \bfseries Status	\\
		\hline\hline
					Researching Solutions					& 3.0						& 100\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
					Researching Chosen Solution				& 5.0						& 100\%				\\
					Creating Feature List					& 4.0						& 100\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
					Researching Implementation				& 2.0						& 20\%				\\
					Setting up Schedule/TeamGantt			& 2.0						& 100\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
...
\subsection{David Larribas}
	...
	\renewcommand{\arraystretch}{1.3}
		...
		\hline\hline
					...
					Societal Problem Research					& 9.0						& 100\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
					Set up Collaborative Tools					& 1.0						& 100\%				\\
...
\subsection{Ben Smith}
	...
	\renewcommand{\arraystretch}{1.3}
		...
		\hline\hline
					...
					Societal Problem Research		& 9.0							& 100\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
					Set up Collaborative Tools		& 2.0							& 100\%				\\
					\LaTeX\ Templates				& 5.0							& 100\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
